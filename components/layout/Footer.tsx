        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-16">
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex items-center gap-4 mb-6">
              <a href="mailto:raffiq_sr@yahoo.co.in" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:border-primary/50 hover:bg-primary/10 transition-all group" title="Email Support" aria-label="Email Support">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
              </a>
              <a href="https://wa.me/919983168522" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:border-[#25D366]/50 hover:bg-[#25D366]/10 transition-all group" title="WhatsApp Support" aria-label="WhatsApp Support">
              ...
              <a href="https://www.linkedin.com/in/mohamed-raffiq-6b97a6a7" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:border-[#0A66C2]/50 hover:bg-[#0A66C2]/10 transition-all group" title="Founder LinkedIn" aria-label="LinkedIn Profile">
          ...
          <div className="md:col-span-1.5">
            ...
            <ul className="space-y-3 text-sm text-white/30">
              ...
              <li><Link href="/careers" className="hover:text-white/70 transition-colors">Careers</Link></li>
            </ul>
          </div>
