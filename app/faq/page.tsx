  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "FoxPlayer currently integrates with AliceBlue, Shoonya, Angel One, Upstox, Groww, Motilal Oswal, Zerodha, and Dhan. Multiple brokers can be connected simultaneously from a single dashboard."
        }
      },
      {
        "@type": "Question",
