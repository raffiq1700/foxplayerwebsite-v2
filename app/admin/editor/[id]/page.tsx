...
import { ArrowLeft, Save, Loader2, Info, Layout, Globe, CheckCircle2 } from "lucide-react";
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          >
            <h2 className="text-xl font-black text-white mb-10 flex items-center gap-3 uppercase tracking-tight">
              <Layout className="w-5 h-5 text-primary" /> Core Content
            </h2>
            ...
            <div className="grid grid-cols-1 gap-8">
              <div>
                ...
                <input
                  ...
                  placeholder="The future of algo trading..."
                  required
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <select
                    ...
                    className={inputClasses}
                  >
                    <option className="bg-[#050505]">Trading</option>
                    <option className="bg-[#050505]">Algo Trading</option>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <label className={labelClasses}>Author Display Name</label>
                  <input
                    name="author"
              ...
              <div>
                <label className={labelClasses}>Brief Excerpt</label>
                <textarea
                  name="excerpt"
                  ...
                  placeholder="A one-sentence hook for the reader..."
                />
              </div>

              <div>
                <label className={labelClasses}>Main Body (Markdown Supported)</label>
                <textarea
                  name="content"
                  value={formData.content}
                  onChange={handleChange}
                  rows={20}
                  className={`${inputClasses} font-mono text-[13px] leading-relaxed resize-y min-h-[400px]`}
          ...
          >
            <h2 className="text-xl font-black text-white mb-10 flex items-center gap-3 uppercase tracking-tight">
              <Globe className="w-5 h-5 text-secondary" /> SEO Optimization
            </h2>
            
            <div className="grid grid-cols-1 gap-8">
              <div>
                <label className={labelClasses}>Meta Title (Google Display)</label>
                <input
                  name="metaTitle"
                  value={formData.metaTitle}
                  onChange={handleChange}
                  className={inputClasses}
                  placeholder="Primary Keyword | Site Name"
                />
              </div>
